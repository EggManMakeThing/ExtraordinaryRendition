package ExtraordinaryRendition;

import ExtraordinaryRendition.campaign.listeners.CampaignEventListener;
import ExtraordinaryRendition.campaign.VengeanceFleetHandler;
import ExtraordinaryRendition.utils.Settings;
...
public class ExtraordinaryRenditionModPlugin extends BaseModPlugin {
    private static final Logger log = Logger.getLogger(ExtraordinaryRenditionModPlugin.class);
    private ExtraordinaryRendition.campaign.listeners.CampaignEventListener listener = null;
    ...
    private void registerListener() {
        if (listener == null || !Global.getSector().getListenerManager().hasListener(ExtraordinaryRendition.campaign.listeners.CampaignEventListener.class)) {
