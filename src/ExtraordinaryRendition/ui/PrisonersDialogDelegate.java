package ExtraordinaryRendition.ui;
...
import ExtraordinaryRendition.utils.AllowedActions;
...
public class PrisonersDialogDelegate implements CustomDialogDelegate {
    ...
    protected final ExtraordinaryRendition.ui.PrisonersDialogPanelPlugin plugin;
    ...
    public void createCustomDialog(CustomPanelAPI panel, CustomDialogCallback callback) {
        ...
        for (PersonAPI member : members) {
            ...
            currYOffset += (ExtraordinaryRendition.ui.ViewPrisonersUI.PRISONER_ROW_SIZE + 3);
        }
    ...
    public TooltipMakerAPI addRow(CustomPanelAPI outer, PersonAPI member) {
        ...
        TooltipMakerAPI rowTooltip = outer.createUIElement(panelWidth, ExtraordinaryRendition.ui.ViewPrisonersUI.PRISONER_ROW_SIZE, false);
        CustomPanelAPI contentHolder = outer.createCustomPanel(panelWidth, ExtraordinaryRendition.ui.ViewPrisonersUI.PRISONER_ROW_SIZE, null);

        // Ship image with tooltip of the ship class
        TooltipMakerAPI portraitHolder = contentHolder.createUIElement(ExtraordinaryRendition.ui.ViewPrisonersUI.PRISONER_ROW_SIZE, ExtraordinaryRendition.ui.ViewPrisonersUI.PRISONER_ROW_SIZE, false);
        portraitHolder.addImage(member.getPortraitSprite(), ExtraordinaryRendition.ui.ViewPrisonersUI.PRISONER_ROW_SIZE, 0);
        contentHolder.addUIElement(portraitHolder).inTL(0, 0);

        // Ship name, class, bandwidth
        TooltipMakerAPI textHolder = contentHolder.createUIElement(textWidth, ExtraordinaryRendition.ui.ViewPrisonersUI.PRISONER_ROW_SIZE, false);
        ...
        TooltipMakerAPI buttonHolder = contentHolder.createUIElement(buttonHolderWidth, ExtraordinaryRendition.ui.ViewPrisonersUI.PRISONER_ROW_SIZE, false);
    ...
    public void removePerson(PersonAPI person, ActionDefinition displayedAction) {
        ...
        if (deletedData != null) {
            ...
            TooltipMakerAPI rowTooltip = panel.createUIElement(panelWidth, ExtraordinaryRendition.ui.ViewPrisonersUI.PRISONER_ROW_SIZE, false);
            CustomPanelAPI pluginHolder = panel.createCustomPanel(panelWidth, ExtraordinaryRendition.ui.ViewPrisonersUI.PRISONER_ROW_SIZE, new TimedUIPlugin(1.25f, listener));
            TooltipMakerAPI textHolder = pluginHolder.createUIElement(panelWidth, ExtraordinaryRendition.ui.ViewPrisonersUI.PRISONER_ROW_SIZE, false);
    ...
    public Set<ActionDefinition> getActions(PersonAPI person) {
        ...
        defs.add(new ExtraordinaryRendition.campaign.actions.definitions.TalkAction(dialog));
        defs.add(new ExtraordinaryRendition.campaign.actions.definitions.HireAction(dialog));
        defs.add(new ExtraordinaryRendition.campaign.actions.definitions.BribeAction(dialog));
        defs.add(new ExtraordinaryRendition.campaign.actions.definitions.RansomAction(dialog));
        defs.add(new ExtraordinaryRendition.campaign.actions.definitions.ReleaseAction(dialog));
