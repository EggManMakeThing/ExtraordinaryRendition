...
public class AllowedActions {
    public static Set<String> get(PersonAPI person) {
        ...
        if (person.getMemoryWithoutUpdate().contains(ExtraordinaryRendition.utils.Strings.ALLOWED_ACTIONS_MEMKEY)) {
            Object acts = person.getMemoryWithoutUpdate().get(ExtraordinaryRendition.utils.Strings.ALLOWED_ACTIONS_MEMKEY);
    ...
    public static void add(PersonAPI person, ExtraordinaryRendition.ui.PrisonersDialogDelegate.ActionDefinition def) {
    ...
    public static void add(PersonAPI person, String defName) {
        ...
        person.getMemoryWithoutUpdate().set(ExtraordinaryRendition.utils.Strings.ALLOWED_ACTIONS_MEMKEY, allowedActionsString);
    }
    ...
    public static boolean contains(PersonAPI person, ExtraordinaryRendition.ui.PrisonersDialogDelegate.ActionDefinition def, boolean mustContain) {
